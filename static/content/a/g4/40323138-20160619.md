...
程式說明: 懂了程式嚙和原理後要畫幾個都不是問題

<img src="http://imgur.com/DAxXWfU.png" width="100%" />
spur(cx, cy, m, n1, pa, 0)   x,y,模數,齒輪,壓力角,偏轉轉角 
...
程式說明:橫式和直式只差了90度只要更改角度再去買x,y座標就好了
...
雖然一開始期中前常常發生錯誤,但也因為這樣才更努力的去研究不讓錯誤發生,也幫班上協處理過很多錯誤,也教了很多人,期末累死了!!!!!!
