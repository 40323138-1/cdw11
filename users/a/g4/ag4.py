...
ag4_1 = Blueprint('ag4_1', __name__, url_prefix='/ag4_1', template_folder='templates')
...
@ag4_1.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@ag4_1.route('/circle1/<x>/<degree>', defaults={'y': 0})
@ag4_1.route('/circle1/<x>/<y>/<degree>')
#@ag4_1.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@ag4_1.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@ag4_1.route('/circle2/<x>/<degree>', defaults={'y': 0})
@ag4_1.route('/circle2/<x>/<y>/<degree>')
#@ag4_1.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@ag4_1.route('/twocircle/<x>/<y>')
@ag4_1.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@ag4_1.route('/eighteenthirty/<x>/<y>')
@ag4_1.route('/eighteenthirty', defaults={'x':0, 'y':0})
...
'''
    return outstring
@ag4_1.route('/threegears', defaults={'n1':17,'n2':29,'n3':15})
@ag4_1.route('/threegears/<n1>/<n2>/<n3>')
...
@ag4_1.route('/gears', defaults={'n1':17,'n2':29,'n3':15,'n4':40,'n5':20})
@ag4_1.route('/gears/<n1>/<n2>/<n3>/<n4>/<n5>')
...
spur(cx+pr1+pr2+pr2+2*pr3+2*pr4+pr5,cy,m,n5,pa,(180+180/n5+(180-180/n3)*n4/n5)-3)
    ...
    return outstring
@ag4_1.route('/gears09', defaults={'n1':17,'n2':29,'n3':15,'n4':40,'n5':20})
@ag4_1.route('/gears09/<n1>/<n2>/<n3>/<n4>/<n5>')
def gears09(n1, n2, n3, n4, n5):
    outstring = '''
<!DOCTYPE html>
<html>
<head>
...
spur(cx+pr1+pr2+pr2+2*pr3+2*pr4+pr5,cy,m,n5,pa,(180+180/n5+(180-180/n3)*n4/n5)-3)
    ...
    return outstring
@ag4_1.route('/gears35', defaults={'n1':17,'n2':29,'n3':15,'n4':40,'n5':20})
@ag4_1.route('/gears35/<n1>/<n2>/<n3>/<n4>/<n5>')
def gear35(n1, n2, n3, n4, n5):
    outstring = '''
<!DOCTYPE html>
<html>
<head>
...
spur(cx+pr1+pr2+pr2+2*pr3+2*pr4+pr5,cy,m,n5,pa,(180+180/n5+(180-180/n3)*n4/n5)-3)
    ...
    return outstring
@ag4_1.route('/gears36', defaults={'n1':17,'n2':29,'n3':15,'n4':40,'n5':20})
@ag4_1.route('/gears36/<n1>/<n2>/<n3>/<n4>/<n5>')
def gear36(n1, n2, n3, n4, n5):
    outstring = '''
<!DOCTYPE html>
<html>
<head>
...
spur(cx+pr1+pr2+pr2+2*pr3+2*pr4+pr5,cy,m,n5,pa,(180+180/n5+(180-180/n3)*n4/n5)-3)
    ...
    return outstring
@ag4_1.route('/gears44', defaults={'n1':17,'n2':29,'n3':15,'n4':40,'n5':20})
@ag4_1.route('/gears44/<n1>/<n2>/<n3>/<n4>/<n5>')
def gear44(n1, n2, n3, n4, n5):
    outstring = '''
<!DOCTYPE html>
<html>
<head>
